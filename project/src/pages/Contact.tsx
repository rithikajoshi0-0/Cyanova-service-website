            ...
            <div className="text-center mb-8">
              ...
              <div className="bg-gradient-to-br from-cyan-50 to-teal-50 border-2 border-dashed border-cyan-300 rounded-xl p-12">
                ...
                <a
                  ...
                  className="bg-gradient-to-r from-cyan-500 to-teal-600 text-white px-6 py-3 rounded-full hover:from-cyan-600 hover:to-teal-700 transition-all duration-300 transform hover:scale-105 shadow-lg inline-flex items-center group"
                >
                  Open Project Form
